...
//         ConnectionModel.update({preferredName, firstName, lastName, network, company, dateReview, profilePhoto, cellPhoneOne, cellPhoneTwo, email, homeAddress, workPhone, workEmail, workAddress, birthday, moreContact}).then((response)=>{
